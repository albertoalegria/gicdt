...
<div class="breadcrumbs">
  <div class="container content">
   ...
   <div class="breadcrumbs">
    <div class="container">
      <h1 class="pull-left">Editar Cursos</h1>
  ...
  <div class='container content'>
    <h3>Reemplaza solo los campos necesarios para la edicion  del curso</h3>  

    {{ Form::open(array('url' => 'curso/update/'.$id ,'enctype'=>'multipart/form-data')) }}
    ...
    <div class="row">
      <div class="col-md-4 col-lg-4">
        ...
        {{Form::text('nombre',$k->nombre,array('class'=>'form-control','placeholder'=>'Introduce el titulo del curso'))}}
      </div>
      <div class="col-md-4 col-lg-4">
        {{Form::label('tipo','Tipo de Curso')}}
        <select name="tipo" id="tipoCurso"  class="form-control">
          <option selected=""  value='{{$k->tipo}}'>{{$k->tipo}}</option>
      ...
      <div class="col-md-4 col-lg-4">
        ...
        <select  name="tipotitulo" class="form-control" >
          <option value='{{$k->nombramiento}}'>{{$k->nombramiento}}</option>
      ...
      <div class="col-md-4 col-lg-4">
        ...
        {{Form::text('precio',$k->couta,array('class'=>'form-control','placeholder'=>'Introduce el precio $',))}}

      </div>

      <div class="col-md-4 col-lg-4">
        {{Form::label('cupo','Lugares Disponibles')}}
        {{Form::number('cupo',$k->cupo,array('class'=>'form-control','placeholder'=>'Introduce el numero de asistentes máximo'))}}
      ...
      <div class="col-md-4 col-lg-4">
        ...
        {{Form::text('keywords',$k->keywords,array('class'=>'form-control','placeholder'=>'Introduce  las palabras claves','data-role'=>'tagsinput'))}}
      ...
      <div class="col-lg-8">
        ...
        {{Form::textarea('desc',$k->descr,array('class'=>'form-control','placeholder'=>'Introduce la descripción del Curso','rows'=>'4'))}}
      ...
      <div class="col-lg-8">
        ...
        {{Form::textarea('ubicacion',$k->lugar,array('class'=>'form-control','placeholder'=>'Ejemplo: Intituto tecnológico de Tuxtla Gutierrez, Edificio de Sistemas Sala COM-1','rows'=>'4'))}}
        <div id="contenedor">
          <h2 class="text-center">Fechas del Curso </h2>
          <hr>
          <?php $f=explode(',', $k->fechas);$i=0;?>
          @foreach ($f as $value)
          <div class="form-group col-lg-4"  id='f_{{$i}}'>
           <div class="input-group date "  id="fecha">
            <input type="text" name="fechas[]" value='{{$value}}' class="form-control">
            <span class='input-group-addon'><span class='glyphicon-calendar glyphicon'></span></span>
          </div>
          <a onclick="eliminar('{{$i++}}')"><i class="fa fa-trash-o"></i>eliminar</a>
        </div>  
        @endforeach 
